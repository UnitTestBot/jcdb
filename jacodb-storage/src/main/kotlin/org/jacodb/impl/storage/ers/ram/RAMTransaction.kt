...
internal class RAMTransaction(override val ers: RAMEntityRelationshipStorage) : Transaction {
    ...
    private var dataContainer: RAMDataContainer? = originContainer
    ...
    override fun getEntityUnsafe(id: EntityId): Entity = RAMEntity(txn = this, id)
    ...
    override fun dropAll() {
        dataContainer = RAMDataContainerMutable()
    }
    ...
    private val dataContainerChecked: RAMDataContainer
